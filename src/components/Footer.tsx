...
const Footer: React.FC = () => {
  return (
    <footer className="bg-[#0A1424] text-gray-300 pt-24 pb-10 px-6">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-16">
        ...
        <div>
          ...
          <div className="flex gap-4 mt-6">
            <a href="#" className="w-10 h-10 rounded-full bg-white/10 hover:bg-blue-600 flex items-center justify-center transition">
              <FaFacebookF size={18} />
            </a>
      ...
      <div className="border-t border-white/10 mt-20 pt-6 text-center text-gray-500 text-sm">
        © 2025 Clinique Life. Tous droits réservés.
      </div>
    </footer>
  );
};
